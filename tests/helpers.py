...
TREE_TYPED_PATHS_NONE_IS_NODE = [
    ...
    [
        ...
        ((tuple, 0), (tuple, 1)),
        ((tuple, 1), (list, 0)),
        ((tuple, 1), (list, 1), (tuple, 0)),
        ((tuple, 1), (list, 1), (tuple, 2)),
    ],
    [((list, 0),)],
    [
        ((list, 0),),
        ((list, 1), (CustomTuple, 0), (tuple, 0)),
        ((list, 1), (CustomTuple, 0), (tuple, 1), (CustomTuple, 0)),
        ((list, 1), (CustomTuple, 1), (dict, 'baz')),
    ],
    [
        ((TimeStructTime, 0),),
        ((TimeStructTime, 1),),
    ...
    [
        ...
        ((SysFloatInfo, 7),),
        ((SysFloatInfo, 8),),
        ((SysFloatInfo, 10), (TimeStructTime, 0)),
        ((SysFloatInfo, 10), (TimeStructTime, 1)),
        ((SysFloatInfo, 10), (TimeStructTime, 2)),
        ((SysFloatInfo, 10), (TimeStructTime, 3)),
        ((SysFloatInfo, 10), (TimeStructTime, 4)),
        ((SysFloatInfo, 10), (TimeStructTime, 6)),
        ((SysFloatInfo, 10), (TimeStructTime, 7)),
        ((SysFloatInfo, 10), (TimeStructTime, 8)),
    ],
    [((list, 0), (Vector3D, 0))],
    ...
    [((OrderedDict, 'foo'),), ((OrderedDict, 'baz'),), ((OrderedDict, 'something'),)],
    [
        ((OrderedDict, 'foo'),),
        ((OrderedDict, 'baz'),),
        ((OrderedDict, 'something'), (deque, 1)),
        ((OrderedDict, 'something'), (deque, 2)),
    ],
    [((OrderedDict, 'foo'),), ((OrderedDict, 'baz'),), ((OrderedDict, 'something'), (deque, 1))],
    [
        ((OrderedDict, 'foo'),),
        ((OrderedDict, 'baz'),),
        ((OrderedDict, 'something'), (deque, 0)),
        ((OrderedDict, 'something'), (deque, 1)),
    ],
    [((defaultdict, 'baz'),), ((defaultdict, 'foo'),), ((defaultdict, 'something'),)],
    [((deque, 1),), ((deque, 2),)],
    [((deque, 1),)],
    [((MyDict, 'foo'), (MyDict, 'b')), ((MyDict, 'foo'), (MyDict, 'a')), ((MyDict, 'baz'),)],
    [()],
    [((CustomNamedTupleSubclass, 0),), ((CustomNamedTupleSubclass, 1),)],
    [],
    [((FlatCache, 0),)],
    [((FlatCache, 0),), ((FlatCache, 1),)],
]
...
TREE_TYPED_PATHS_NONE_IS_LEAF = [
    ...
    [
        ...
        ((list, 1), (CustomTuple, 0), (tuple, 0)),
        ((list, 1), (CustomTuple, 0), (tuple, 1), (CustomTuple, 0)),
        ((list, 1), (CustomTuple, 0), (tuple, 1), (CustomTuple, 1)),
        ((list, 1), (CustomTuple, 1), (dict, 'baz')),
    ],
    [
        ((TimeStructTime, 0),),
    ...
    [
        ...
        ((SysFloatInfo, 10), (TimeStructTime, 3)),
        ((SysFloatInfo, 10), (TimeStructTime, 4)),
        ((SysFloatInfo, 10), (TimeStructTime, 5)),
        ((SysFloatInfo, 10), (TimeStructTime, 6)),
        ((SysFloatInfo, 10), (TimeStructTime, 7)),
        ((SysFloatInfo, 10), (TimeStructTime, 8)),
    ],
    [((list, 0), (Vector3D, 0)), ((list, 0), (Vector3D, 1))],
    [((Vector2D, 0),), ((Vector2D, 1),)],
    [((dict, 'a'),), ((dict, 'b'),)],
    [
        ((dict, 'a'),),
